  ...
  return ( <>
    <fieldset> 
      ...
      <div className="form-control-field field-email">
        ...
        <div className="form-control-field__input-container">
          <div className="input-wrap d-flex align-items-center"> 
            ...
            <button type="button" className="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#modal-verification">인증하기</button>
          </div>
      ...
      <div className="form-control-field field-name">
        ...
        <div className="form-control-field__input-container">
          <input type="text" className="form-control" name="name" placeholder="" data-is-validation='0' required />
        </div>
      </div>
      ...
      <div className="form-control-field field-nickname">
        ...
        <div className="form-control-field__input-container">
          <input type="text" className="form-control" name="nickname" placeholder="" data-is-validation='0' required />
        </div>
      </div>
