...
/* 용어 및 카테고리 
*/ 
export async function fetchAsyncTermsAllCategory ( taxonomy: string, callback: null | ( (datas:any|null )=> any ) ) {
...
/* 채팅 프롬프트 : 답변 검색
*/ 
export async function fetchAsyncChatAnswersSearch ( keywords: string[], callback: null | ( (datas:any|null )=> any ) ) {
...
/* 채팅 프롬프트 : 문장에서 키워드 추출 
 - FEST API
*/ 
export async function fetchAsyncExtKeywords ( context: string, callback: null | ( (datas:any|null )=> any ) ) {
